...
public class Stage_UI_Presenter : MonoBehaviour
{
    ...
    IReactiveProperty<int> health;
    IReactiveProperty<int> bomb;
    IReactiveProperty<int> rope;
    IReactiveProperty<int> money;
    IReactiveProperty<int> stage;
    IReactiveProperty<int> time;
    private void Awake()
    {
        if (Instance == null)
        {
    ...
    void GotoBook() => StartCoroutine(Get_View.GetMaskVariation.Darker(CameraChange));
    void CameraChange()
    {
